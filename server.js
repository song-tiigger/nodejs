...
let db;
MongoClient.connect('mongodb+srv://admin:thdgkwjd@cluster0.pfro1d9.mongodb.net/?retryWrites=true&w=majority', function (error, client) {
...
app.get('/detail/:id', function(req, res) {
    db.collection('post').findOne({_id : parseInt(req.params.id)}, function(error, result) {
        console.log(result);
        if (!result) { return res.send('해당 데이터가 없습니다.') }
